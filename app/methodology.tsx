...
export default function MethodologyScreen() {
  ...
  return <ScreenContainer className="px-5" edges={["top", "bottom", "left", "right"]}><MotionIn className="flex-1"><FlatList data={sourceDirectory} keyExtractor={(source) => source.id} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingTop: 14, paddingBottom: 28 }} ListHeaderComponent={<>
    ...
    <View style={{ backgroundColor: colors.primary, borderRadius: 24, padding: 18, marginBottom: 12 }}><Text style={{ color: "#F8E7B6", fontSize: 13, fontWeight: "800", ...rtl }}>فلسفة سَكينة</Text><Text style={{ color: "#FFFFFF", fontSize: 24, fontWeight: "800", marginTop: 7, ...rtl }}>لا سند، لا نص</Text><Text style={{ color: "#D2E9DF", fontSize: 13, lineHeight: 21, marginTop: 8, ...rtl }}>نفتح الطريق إلى المرجع، ولا نستبدل به بطاقة مجهولة أو نصًا بلا توثيق.</Text></View>
