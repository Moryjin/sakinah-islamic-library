...
export const sourceDirectory = [
  ...
  { id: "hadith-open-data", name: "Hadith API · الصحيحان", scope: "بيانات مفتوحة للنص العربي وأرقام الكتب والأحاديث في البخاري ومسلم", url: "https://github.com/fawazahmed0/hadith-api", icon: "format-quote", allowed: true },
...
export const libraryItems: LibraryItem[] = [
  ...
  },
  {
    ...
    recitations: [
      ...
      { title: "آية الكرسي · سعود الشريم", reciter: "الشيخ سعود الشريم", riwayah: "غير مذكورة في صفحة الملف", publisher: "Wikimedia Commons · StroveAnimations", license: "CC0 1.0", licenseUrl: "https://creativecommons.org/publicdomain/zero/1.0/", sourcePage: "https://commons.wikimedia.org/wiki/File:Ayatul_Kursi-_Saud_Al-Shuraim.wav", audioUrl: "https://upload.wikimedia.org/wikipedia/commons/transcoded/e/ea/Ayatul_Kursi-_Saud_Al-Shuraim.wav/Ayatul_Kursi-_Saud_Al-Shuraim.wav.mp3", note: "يستخدم التطبيق النسخة MP3 المرَمّزة من الملف نفسه لتفادي أخطاء الخادم المؤقتة، مع بقاء صفحة المصدر والرخصة كما هما." },
    ],
  },
  {
